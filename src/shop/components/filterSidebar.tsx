      ...
      <div className="space-y-4">
        ...
        <RadioGroup defaultValue="" className="space-y-3">
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="priceAny" className="cursor-pointer text-sm">
              Cualquier precio
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="price1" className="cursor-pointer text-sm">
              $0 - $50
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="price2" className="cursor-pointer text-sm">
              $50 - $100
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="price3" className="cursor-pointer text-sm">
              $100 - $200
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="price4" className="cursor-pointer text-sm">
              $200+
            </Label>
          </div>
        </RadioGroup>
